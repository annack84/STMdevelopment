...
```{r NbClust-ack-rank, echo=FALSE, message=FALSE, warning=FALSE}
...
indvalsummary_disp_filt <- filter(indvalsummary_disp, pvalue<=0.1) %>%
...
pal_veg <- RColorBrewer::brewer.pal(n=k_groups_SandyUplands, name = "Set3")
