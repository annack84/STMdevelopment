...
# remove rare species
sp_pa <- mutate(rowwise(ord.df), across(everything(), function(x){if(x==0|is.na(x)){0}else{1}})) # make a presence/absence data frame
...
```
Note that the k-means results for NbClust are similar to the fanny results if the membership exponent is close to 1.
