...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.height=7, fig.width=10, fig.cap="Plant cover by clustering group"}
...
```{r pull-env-vars, eval=FALSE, echo=FALSE}
...
```{r env-plots, eval=FALSE, echo=FALSE, fig.height=10, fig.width=10, fig.cap="Arrow diagrams for environmental variables"}
