...
sf::st_write(fuzzy_cluster_memb_sf,
             dsn = "C:/Users/aknight/Desktop/Telework_Backups/V_drive/PROJECTS/ESG/Maps",
             layer = paste0("SW_LoamyUplands_fuzzyclusters_", Sys.Date(), ".shp"),
             driver = "ESRI Shapefile")

fuzzy_cluster_memb_sf_shareable <- filter(fuzzy_cluster_memb_sf, !grepl(pattern = "NRI|IM_NCPN", x=PlotCode))
...
knitr::include_graphics("C:/Users/aknight/Desktop/Telework_Backups/V_drive/PROJECTS/ESG/STM/Analyses/Semiarid_Warm_LoamyUplands_boxandarrow_DRAFT.JPG")
```
