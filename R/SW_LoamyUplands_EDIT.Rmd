...
plot_scores <- left_join(plot_scores, select(plot_data_descriptive, PlotCode, PlantCommunity_fuzzy))
...
ord_pretty_plot <- function(points = plot_scores,
                            ...
                            y_axis = "NMDS2",
                            palette = pal_veg2,
                            group_labels = group_labels_fuzzy){
  ord_plot <- ggplot(data = points, aes_string(x=x_axis, y=y_axis)) +
    #geom_point(data = points, aes_string(x=x_axis, y=y_axis, color="PlantCommunity_fuzzy"), size=1) +
    stat_ellipse(data=points, aes_string(x=x_axis, y=y_axis, color="PlantCommunity_fuzzy"),
                 level = 0.5, lwd = 1) +
    ...
    ggrepel::geom_label_repel(data = vectors, # put labels on the arrows
...
violin_pretty_plot <- function(dat = plot_data_descriptive,
  ...
  violin_plot <- ggplot(data = dat,
       aes_string(x="PlantCommunity_fuzzy", y=y_var)) +
...
# aero
aero_plot <- violin_pretty_plot(dat = filter(plot_data_descriptive, !is.na(horizontal_flux_total_MN)),
                                y_var = "horizontal_flux_total_MN",
...
# soil stability
soilstab_plot <- violin_pretty_plot(dat = plot_data_descriptive,
                                    y_var = "SoilStab_all",
                                    y_lab = "Soil stability")
soilstab_plot

# climate?
AI_plot <- violin_pretty_plot(dat = plot_data_descriptive,
                              y_var = "AI",
                              y_lab = "Aridity index")
AI_plot

ppt_plot <- violin_pretty_plot(dat = plot_data_descriptive,
                               y_var = "Ann_ppt_mm",
                               y_lab = "Mean ann. ppt. (mm)")
ppt_plot

tmean_plot <- violin_pretty_plot(dat = plot_data_descriptive,
                               y_var = "Ann_tmean",
...
highrestiff(plot_obj = abiotic_plots,
            file = "C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/Violin/SW_LoamyUplands_abiotic_violin.tif",
            width_in = 6,
            height_in = 6,
            resolution_dpi = 300)
...
afg_npp_plot <- violin_pretty_plot(dat = plot_data_descriptive, 
                               y_var = "afgNPP",
                               y_lab = "Ann. herb. NPP (g C/m2)")
afg_npp_plot

pfg_npp_plot <- violin_pretty_plot(dat = plot_data_descriptive, 
                               y_var = "pfgNPP",
                               y_lab = "Per. herb. NPP (g C/m2)")
pfg_npp_plot

shr_npp_plot <- violin_pretty_plot(dat = plot_data_descriptive, 
                               y_var = "shrNPP",
                               y_lab = "Shrub NPP (g C/m2)")
shr_npp_plot

tre_npp_plot <- violin_pretty_plot(dat = plot_data_descriptive, 
                               y_var = "treNPP",
...
highrestiff(plot_obj = pft_npp_plots,
            file = "C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/Violin/SW_LoamyUplands_pftnpp_violin.tif",
            width_in = 6,
            height_in = 6.5,
            resolution_dpi = 300)
...
herb_npp_plot <- violin_pretty_plot(dat = plot_data_descriptive, 
                               y_var = "herbNPP",
                               y_lab = "Herb. NPP (g C/m2)")
herb_npp_plot

woody_npp_plot <- violin_pretty_plot(dat = plot_data_descriptive, 
                               y_var = "woodyNPP",
                               y_lab = "Woody NPP (g C/m2)")
woody_npp_plot

total_npp_plot <- violin_pretty_plot(dat = plot_data_descriptive, 
                               y_var = "totalNPP",
...
highrestiff(plot_obj = gh_npp_plots,
            file = "C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/Violin/SW_LoamyUplands_ghnpp_violin.tif",
            width_in = 3,
            height_in = 9,
            resolution_dpi = 300)

# 4. biodiversity
diversity_plot <- violin_pretty_plot(dat = plot_data_descriptive,
                                     y_var = "shannon_diversity",
                                     y_lab = "Shannon diversity index")
diversity_plot

richness_plot <- violin_pretty_plot(dat = plot_data_descriptive,
                                     y_var = "sp_richness",
                                     y_lab = "Number of species")
richness_plot

biodiversity_plots <- cowplot::plot_grid(diversity_plot + xlab(NULL) + scale_x_discrete(labels=NULL),
                                         richness_plot,
...
highrestiff(plot_obj = biodiversity_plots,
            file = "C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/Violin/SW_LoamyUplands_biodiversity_violin.tif",
            width_in = 3,
            height_in = 6.5,
            resolution_dpi = 300)
...
variance_plot <- violin_pretty_plot(dat = plot_data_descriptive,
                                     y_var = "resid_variance",
                                     y_lab = "Variance")
variance_plot

AC1_plot <- violin_pretty_plot(dat = plot_data_descriptive,
                                     y_var = "resid_AC1",
...
highrestiff(plot_obj = RSvariability_plots,
            file = "C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/Violin/SW_LoamyUplands_RSvariability_violin.tif",
            width_in = 3,
            height_in = 6,
            resolution_dpi = 300)
