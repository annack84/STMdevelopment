...
```{r plant-groups, echo=FALSE, message=FALSE, warning=FALSE, fig.height=10, fig.width=10, fig.cap="Plant cover by clustering group"}
...
# TODO add in legible plant names, label plots by functional group, fix color palettes and y axis ranges, and arrange in a grid with cowplot
woody_cover_states <- ggplot(data = filter(plot_data_first_tall, CoverType %in% c("AH_ArtemisiaTridentataCover",
                                                                                  "CHVI8",
                                                                                  "SYRO",
                                                                                  "ERNA10",
                                                                                  "SAVE4",
...
perenherb_cover_states <- ggplot(data = filter(plot_data_first_tall, CoverType %in% c("AH_C3IntroducedPerenGrassCover", 
                                             "AH_C3NativePerenGrassCover", 
                                             "AH_C4IntroducedPerenGrassCover",
                                             "AH_C4NativePerenGrassCover",
                                             "AH_IntroducedPerenForbCover",    
...
annherb_cover_states <- ggplot(data = filter(plot_data_first_tall, CoverType %in% c("AH_IntroducedAnnForbCover",
                                             "AH_IntroducedAnnGrassCover",
                                             "AH_NativeAnnForbCover", 
                                             "AH_NativeAnnGrassCover" 
                                             )),
...
ground_cover_states <- ggplot(data = filter(plot_data_first_tall, CoverType %in% c("BareSoilCover",                  
                                             "FH_TotalLitterCover", 
                                             "CA_percent_200plus", 
                                             "FH_LichenMossCover",
                                             "CA_percent_100plus"
...
group_labels_fuzzy <- c("1 - Depauperate C4 perennial grassland",
                        "2 - Bare ground",
