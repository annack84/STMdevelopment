...
format_tables_EDIT_style(data = dom_spp_grp4_pub,
                         caption = "Community 1.2 plant community composition") %>%
  collapse_rows(columns = 1, valign = "top")
```
...
```{r comm3-2-dominant-spp, echo=FALSE, error=FALSE, warning=FALSE, message=FALSE}
...
format_tables_EDIT_style(data = dom_spp_grp5_pub,
                         caption = "Community 3.2 plant community composition") %>%
  collapse_rows(columns = 1, valign = "top")
```
