...
Based on the results from the three different tests, `r k_groups` is a reasonable numbe for groups to start with. 
...
ord2 <- metaMDS(norm.df,
               ...
               distance = "euclidean" # you have to use the same distance metric as you did for you clustering technique (https://www.davidzeleny.net/anadat-r/doku.php/en:hier-agglom_examples)
               )  
