...
```{r map, eval=TRUE, echo=FALSE, error=FALSE, warning=FALSE, message=FALSE, fig.cap="Mapped extent", fig.width=7.48, fig.height=7.48}
EDIT_map(target_ESG = target_ESG, user = user, maxZoomStyle = "public")
```

Areas shown in blue indicate the maximum mapped extent of this ecological site group (Nauman et al., 2022). Other ecological sites likely occur within the highlighted areas. It is also possible for this ecological site to occur outside of highlighted areas if detailed soil survey has not been completed or recently updated.
...
These sites have high risk for wind erosion and dune mobilization, especially with drought or large disturbances (Nauman et al., 2022). Water erosion issues are possible. Compared to reference states, alternative states may have annual invasion, woody encroachment, and/or loss of perennial grasses.
...
```{r ordination-plots, echo=FALSE, fig.height=8, fig.width=8, fig.cap="NMDS ordination of plot indicator data. Points represent plots; ellipses represent plant communities identified by the hierarchical clustering and indicator species analysis."}
# 2D plotting
...
```{r plant-groups, echo=FALSE, message=FALSE, warning=FALSE, fig.height=16, fig.width=8, fig.cap="Plant cover by state"}
