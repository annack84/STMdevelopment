...
```{r groups-climate, echo=FALSE, message=FALSE, warning=FALSE, fig.height=8, fig.width=8, fig.cap="Climate gradients by state. Larger aridity index values indicate a less arid condition. Aridity index data from Trabucco and Zomer (2018); precipitation and temperature data from PRISM Climate Group (2020)"}
# group_labels_fuzzy <- paste0(group_labels_base,
#                                " (n = ",
...
```{r groups-soils, echo=FALSE, message=FALSE, warning=FALSE, fig.height=8, fig.width=8, fig.cap="Soil texture, rock content, and depth class by state, based on digital soil maps (Nauman and Duniway, 2020; Brungard et al., 2021)."}
# soil depth figure
...
cowplot::plot_grid(ggplot(data = plot_data_descriptive,
  ...
  scale_fill_manual(name="State", labels=state_labels_fuzzy, values = pal_veg2) +
  xlab(NULL) +
  ylab("Relative native plant cover (%)") +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "none"),
  nrow = 1, labels = "auto")
...
```{r groups-erosion, echo=FALSE, message=FALSE, warning=FALSE, fig.height=12, fig.width=12, fig.cap="Erosion potential by state. Modelled wind erosion (a) is based on AERO models and is only available for  (Edwards et al., 2022)."}
...
# fix weird names
dom_spp_grp2[SpeciesCode=="PSSP6", "ScientificName"] <- "Pseudoroegneria spicata"
...
# fix weird names
dom_spp_grp1[SpeciesCode=="PLPA2", "ScientificName"] <- "Plantago patagonica"
...
# fix weird names
dom_spp_grp4[SpeciesCode=="OPUNT", "ScientificName"] <- "Opuntia spp."
...
# fix weird names
dom_spp_grp3[SpeciesCode=="PLPA2", "ScientificName"] <- "Plantago patagonica"
dom_spp_grp3[SpeciesCode=="CETE5", "ScientificName"] <- "Ceratocephala testiculata"
