...
```{r groups-erosion, echo=FALSE, message=FALSE, warning=FALSE, fig.height=5, fig.width=6.25, fig.cap="Erosion potential by state. Modelled wind erosion (a) is based on AERO models and is only available for  (Edwards et al., 2022)."}
