...
Transition and restoration pathways and drivers were derived by tabulating the transitions and drivers for similar states in the Ecological Site Description STMs linked to this Ecological Site Group (Table \@ref(tab:assoc-eco-sites)). They were confirmed by comparing to the field plot locations overlaid on geospatial data representing land protection status, fire history, woody removal treatments, and recent drought conditions. They were also reviewed by a group of land management experts familiar with this ESG.
...
```{r groups-erosion, echo=FALSE, message=FALSE, warning=FALSE, fig.height=8, fig.width=5.51, fig.cap="Erosion potential by state. Modelled wind erosion (a) is based on AERO models and is only available for  (Edwards et al., 2022)."}
