...
```{r groups-soils, echo=FALSE, message=FALSE, warning=FALSE, fig.height=10, fig.width=10, fig.cap="Soil attributes by plant community"}
# group_labels_fuzzy <- paste0(group_labels_base,
#                                " (n = ",
...
cowplot::plot_grid(
ggplot(data = plot_data_descriptive,
       aes(x=PlantCommunity_fuzzy, y=clay_pct_mean)) +
  geom_boxplot() +
  scale_x_discrete(labels=group_labels_fuzzy) +
  ylim(c(0, 100)) +
  xlab("Plant community") +
  ylab("Mean clay (%, 0 - 30 cm)") +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)),
ggplot(data = plot_data_descriptive,
       aes(x=PlantCommunity_fuzzy, y=sand_pct_mean)) +
  geom_boxplot() +
  scale_x_discrete(labels=group_labels_fuzzy) +
  ylim(c(0, 100)) +
  xlab("Plant community") +
  ylab("Mean sand (%, 0 - 30 cm)") +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)),
ggplot(data = plot_data_descriptive,
       aes(x=PlantCommunity_fuzzy, y=fragment_pct_mean)) +
  geom_boxplot() +
  scale_x_discrete(labels=group_labels_fuzzy) +
  ylim(c(0, 100)) +
  xlab("Plant community") +
  ylab("Mean rock fragments (%, 0 - 30 cm)") +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)),
labels = "auto"
)
