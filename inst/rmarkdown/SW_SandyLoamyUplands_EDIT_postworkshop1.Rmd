...
knitr::include_graphics("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Analyses/Semiarid_Warm_SandyLoamyUplands_boxandarrow_workshop1.JPG")
```
...
plot_data_descriptive <- select(plot_data_descriptive, SourceKey, PlotID, SiteName, PlotName,
                        ...
                        AH_WoodyCover, AH_ShrubCover, AH_SubShrubCover, AH_TreeCover, AH_ForbGrassCover, 
                        AH_PerenForbGrassCover, AH_AnnForbGrassCover,
                        SoilStab_all, FH_CyanobacteriaCover, CA_percent_100plus, CA_percent_200plus, all_of(sp_keep_desc))
...
# Going with excluding plots with less than 0.6 membership value in their best group.
...
highrestiff(plot_obj = ord_plot_all,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Ordination/SW_SandyLoamyUplands_NMDS_ellipses_functypes_", today, ".tif"),
            width_in = 6,
            height_in = 6,
            resolution_dpi = 300)
...
highrestiff(plot_obj = ord_plot_all_nolabels,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Ordination/SW_SandyLoamyUplands_NMDS_ellipses_functypes_nolabels_", today, ".tif"),
            width_in = 6,
            height_in = 6,
            resolution_dpi = 300)
...
# aero
aero_plot <- box_pretty_plot(dat = filter(plot_data_descriptive_memb, !is.na(horizontal_flux_total_MN)),
                                y_var = "horizontal_flux_total_MN",
...
# soil stability
soilstab_plot <- box_pretty_plot(dat = plot_data_descriptive_memb,
                                    y_var = "SoilStab_all",
                                    y_lab = "Soil stability")
soilstab_plot

# climate?
AI_plot <- box_pretty_plot(dat = plot_data_descriptive_memb,
                              y_var = "AI",
                              y_lab = "Aridity index")
AI_plot

ppt_plot <- box_pretty_plot(dat = plot_data_descriptive_memb,
                               y_var = "Ann_ppt_mm",
                               y_lab = "Mean ann. ppt. (mm)")
ppt_plot

tmean_plot <- box_pretty_plot(dat = plot_data_descriptive_memb,
                               y_var = "Ann_tmean",
                               y_lab = "Mean ann. temp. (C)")
tmean_plot

# rhem
rhem_plot_runoff <- box_pretty_plot(dat = plot_data_descriptive_memb,
                                    y_var = "Runoff_Long_Term_MEAN",
                                    y_lab = "Mean runoff
(mm/yr)")
rhem_plot_runoff

rhem_plot_soilloss <- box_pretty_plot(dat = plot_data_descriptive_memb,
...
highrestiff(plot_obj = abiotic_plots,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Boxplot/SW_SandyLoamyUplands_abiotic_boxplot_2_", today, ".tif"),
            width_in = 6,
            height_in = 9,
            resolution_dpi = 300)
...
highrestiff(plot_obj = climate_plots,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Boxplot/SW_SandyLoamyUplands_climate_boxplot_membership_restricted_", today, ".tif"),
            width_in = 9,
            height_in = 3.5,
            resolution_dpi = 300)
...
highrestiff(plot_obj = soils_plots,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Boxplot/SW_SandyLoamyUplands_soils_boxplot_membership_restricted_", today, ".tif"),
            width_in = 6,
            height_in = 6,
            resolution_dpi = 300)
...
plot_data_descriptive_memb <- left_join(plot_data_descriptive_memb, npp)

afg_npp_plot <- box_pretty_plot(dat = plot_data_descriptive_memb, 
                               y_var = "afgNPP",
                               y_lab = "Ann. herb. NPP (g C/m2)")
afg_npp_plot

pfg_npp_plot <- box_pretty_plot(dat = plot_data_descriptive_memb, 
                               y_var = "pfgNPP",
                               y_lab = "Per. herb. NPP (g C/m2)")
pfg_npp_plot

shr_npp_plot <- box_pretty_plot(dat = plot_data_descriptive_memb, 
                               y_var = "shrNPP",
                               y_lab = "Shrub NPP (g C/m2)")
shr_npp_plot

tre_npp_plot <- box_pretty_plot(dat = plot_data_descriptive_memb, 
                               y_var = "treNPP",
...
highrestiff(plot_obj = pft_npp_plots,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Boxplot/SW_SandyLoamyUplands_pftnpp_boxplot_", today, ".tif"),
            width_in = 6,
            height_in = 6.5,
            resolution_dpi = 300)

# combining npp to herbaceous, woody, and total
plot_data_descriptive_memb$herbNPP <- plot_data_descriptive_memb$afgNPP + plot_data_descriptive_memb$pfgNPP
plot_data_descriptive_memb$woodyNPP <- plot_data_descriptive_memb$shrNPP + plot_data_descriptive_memb$treNPP
plot_data_descriptive_memb$totalNPP <- plot_data_descriptive_memb$herbNPP + plot_data_descriptive_memb$woodyNPP

herb_npp_plot <- box_pretty_plot(dat = plot_data_descriptive_memb, 
                               y_var = "herbNPP",
                               y_lab = "Herb. NPP (g C/m2)")
herb_npp_plot

woody_npp_plot <- box_pretty_plot(dat = plot_data_descriptive_memb, 
                               y_var = "woodyNPP",
                               y_lab = "Woody NPP (g C/m2)")
woody_npp_plot

total_npp_plot <- box_pretty_plot(dat = plot_data_descriptive_memb, 
                               y_var = "totalNPP",
...
highrestiff(plot_obj = gh_npp_plots,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Boxplot/SW_SandyLoamyUplands_ghnpp_boxplot_", today, ".tif"),
            width_in = 3,
            height_in = 9,
            resolution_dpi = 300)

highrestiff(plot_obj = total_npp_plot,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Boxplot/SW_SandyLoamyUplands_totalnpp_boxplot_2_", today, ".tif"),
            width_in = 3,
            height_in = 3.5,
            resolution_dpi = 300)
...
# 4. biodiversity
diversity_plot <- box_pretty_plot(dat = plot_data_descriptive_memb,
                                     y_var = "shannon_diversity",
                                     y_lab = "Shannon diversity index")
diversity_plot

richness_plot <- box_pretty_plot(dat = plot_data_descriptive_memb,
                                     y_var = "sp_richness",
...
highrestiff(plot_obj = biodiversity_plots,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Boxplot/SW_SandyLoamyUplands_biodiversity_boxplot_membership_restricted_", today, ".tif"),
            #width_in = 3,
            width_in = 9,
            #height_in = 6.5,
            height_in = 3.5,
...
sampleyears <- select(plot_data_descriptive_memb, PlotCode, Year) %>%
...
# make figures
plot_data_descriptive_memb <- left_join(plot_data_descriptive_memb, select(VegCover_variance, PlotCode, resid_variance, resid_AC1))

variance_plot <- box_pretty_plot(dat = plot_data_descriptive_memb,
                                     y_var = "resid_variance",
                                     y_lab = "Variance")
variance_plot

AC1_plot <- box_pretty_plot(dat = plot_data_descriptive_memb,
                                     y_var = "resid_AC1",
...
highrestiff(plot_obj = RSvariability_plots,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Boxplot/SW_SandyLoamyUplands_RSvariability_boxplot_", today, ".tif"),
            width_in = 3,
            height_in = 6,
            resolution_dpi = 300)

variance_violin <- violin_pretty_plot(dat = plot_data_descriptive_memb,
                                      y_var = "resid_variance",
                                      y_lab = "Variance",
                                      fill_var = "PlantCommunity_fuzzy_reordered")
variance_violin
...
highrestiff(plot_obj = variance_violin,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Violin/SW_SandyLoamyUplands_variance_violin_", today, ".tif"),
            width_in = 3,
            height_in = 3.5,
            resolution_dpi = 300)
...
functypes_cover_plot <- ggplot(data = select(plot_data_descriptive_memb, 
...
highrestiff(plot_obj = functypes_cover_plot,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Boxplot/SW_SandyLoamyUplands_pftcover_boxplot_", today, ".tif"),
            width_in = 6,
            height_in = 3.5,
            resolution_dpi = 300)
...
mtbs_summary <- mtbs_plots %>%
  ...
  filter(PlotCode %in% plot_data_descriptive_memb$PlotCode) %>% 
...
highrestiff(plot_obj = burn_plot,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Bar/SW_SandyLoamyUplands_MTBSpctburnedpresample_boxplot_", today, ".tif"),
            width_in = 3,
            height_in = 3.5,
            resolution_dpi = 300)
...
highrestiff(plot_obj = burn_plot_post,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Bar/SW_SandyLoamyUplands_MTBSpctburnedpostsample_boxplot_", today, ".tif"),
            width_in = 3,
            height_in = 3.5,
            resolution_dpi = 300)
...
plots_per_group <- data.frame(Best_group = c(1:4),
                              plots_per_group = c(nrow(filter(plot_data_descriptive_memb, PlantCommunity_fuzzy==1)),
                                                  nrow(filter(plot_data_descriptive_memb, PlantCommunity_fuzzy==2)),
                                                  nrow(filter(plot_data_descriptive_memb, PlantCommunity_fuzzy==3)),
                                                  nrow(filter(plot_data_descriptive_memb, PlantCommunity_fuzzy==4))
                                                  ))
...
highrestiff(plot_obj = treatments_plot_pcts,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Bar/SW_SandyLoamyUplands_PJtreatments_pct_barplot_membership_restricted_", today, ".tif"),
            width_in = 6,
            height_in = 3.5,
            resolution_dpi = 300)
...
plot_data_descriptive_memb <- left_join(plot_data_descriptive_memb, select(plot_GAP, PlotCode, PADUS_GAP_Status_Code1))

GAP_proportions <- plot_data_descriptive_memb %>%
  group_by(PlantCommunity_fuzzy_reordered) %>%
...
highrestiff(plot_obj = protection_plot,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Bar/SW_SandyLoamyUplands_PADUSprotection_flipped_barplot_", today, ".tif"),
            width_in = 6,
            height_in = 3.5,
            resolution_dpi = 300)
...
group_labels_fuzzy <- paste0(group_labels_base,
                               " (n = ",
                               c(nrow(filter(plot_data_descriptive_memb, PlantCommunity_fuzzy==1)),
                                 nrow(filter(plot_data_descriptive_memb, PlantCommunity_fuzzy==2)),
                                 nrow(filter(plot_data_descriptive_memb, PlantCommunity_fuzzy==3)),
                                 nrow(filter(plot_data_descriptive_memb, PlantCommunity_fuzzy==4))
                                  ),
...
highrestiff(plot_obj = protection_plot2,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Bar/SW_SandyLoamyUplands_PADUSprotection_dodge_barplot_", today, ".tif"),
            width_in = 6,
            height_in = 3.5,
            resolution_dpi = 300)

GAP_proportions_byclass <- plot_data_descriptive_memb %>%
...
highrestiff(plot_obj = disturbance_plots,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Bar/SW_SandyLoamyUplands_disturbanceproctection_barplot_membership_restricted_", today, ".tif"),
            width_in = 7,
            height_in = 3.5,
            resolution_dpi = 300)
...
highrestiff(plot_obj = functypes_cover_states,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/JFSP_Workshop_1/PlantFuncTypes_", "Woodland", "_", today, ".tif"),
            width_in = 6,
            height_in = 3.5,
            resolution_dpi = 300)
...
highrestiff(plot_obj = ground_cover_states,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/JFSP_Workshop_1/GroundCover_", "Grassland", "_", today, ".tif"),
            width_in = 6,
            height_in = 3.5,
            resolution_dpi = 300)
