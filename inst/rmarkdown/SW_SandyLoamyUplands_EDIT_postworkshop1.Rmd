...
highrestiff(plot_obj = climate_plots,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Boxplot/SW_SandyLoamyUplands_climate_boxplot_", today, ".tif"),
            width_in = 9,
            height_in = 3.5,
            resolution_dpi = 300)
...
highrestiff(plot_obj = soils_plots,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Boxplot/SW_SandyLoamyUplands_soils_boxplot_", today, ".tif"),
            width_in = 6,
            height_in = 6,
            resolution_dpi = 300)
...
npp$Year <- as.numeric(substr(NPP_files[1], 174, 177))

for(file in NPP_files[-1]){
  npp_temp <- read.csv(file)
  npp_temp$Year <- as.numeric(substr(file, 174, 177))
...
highrestiff(plot_obj = biodiversity_plots,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Boxplot/SW_SandyLoamyUplands_biodiversity_boxplot_", today, ".tif"),
            #width_in = 3,
            width_in = 9,
            #height_in = 6.5,
            height_in = 3.5,
...
highrestiff(plot_obj = treatments_plot_pcts,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Bar/SW_SandyLoamyUplands_PJtreatments_pct_barplot_", today, ".tif"),
            width_in = 6,
            height_in = 3.5,
            resolution_dpi = 300)
...
highrestiff(plot_obj = disturbance_plots,
            file = paste0("C:/Users/aknight/Documents/Telework_Backups/V_drive/ANNA_KNIGHT/ESG/STM/Figures/", target_ESG, "/Bar/SW_SandyLoamyUplands_disturbanceproctection_barplot_", today, ".tif"),
            width_in = 7,
            height_in = 3.5,
            resolution_dpi = 300)
...
woodland_fit_data <- select(woodland_data_first, PlotCode,
                            PIED, JUOS, QUGA) %>%
  left_join(., select(plot_data_descriptive, PlotCode, AH_TreeCover, AH_ShrubCover, AH_WoodyCover))
...
woodland_ord.fit_12 <- envfit(woodland_ord ~
                               PIED +
                               JUOS +
                               QUGA +
                               AH_TreeCover +
                               AH_ShrubCover
                             ,
                      data=woodland_fit_data, na.rm=T, choices=1:2)

woodland_ord.fit_32 <- envfit(woodland_ord ~
                               PIED +
                               JUOS +
                               QUGA +
                               AH_TreeCover +
                               AH_ShrubCover
                             ,
                      data=woodland_fit_data, na.rm=T, choices=c(3,2))

woodland_ord.fit_13 <- envfit(woodland_ord ~
                               PIED +
                               JUOS +
                               QUGA +
                               AH_TreeCover +
                               AH_ShrubCover
                             ,
                      data=woodland_fit_data, na.rm=T, choices=c(1,3))
